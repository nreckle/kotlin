...
如需根据本风格指南配置 IntelliJ 格式化程序，请安装 `Kotlin` 插件 1.2.20 或更高版本，转到 **Settings | Editor | Code Style | Kotlin**，点击右上角的 **Set from…** 链接，并从菜单中选择 **Kotlin style guide**。

如需验证代码已按风格指南格式化，请转到 **Settings | Editor | Inspections** 并启用 **Kotlin | Style issues | File is not formatted according to project settings** 探查项。 验证风格指南中描述的其他问题（如命名约定）的附加探查项默认已启用。
...
对于枚举常量，可以使用大写、下划线分隔的名称 ([screaming snake case](https://en.wikipedia.org/wiki/Snake_case)) （`enum class Color { RED, GREEN }`）也可使用首字母大写的常规驼峰名称，具体取决于用途。
...
- [Enumerations](https://www.kotlincn.net/docs/reference/coding-conventions.html#enumerations)
- [Value arguments](https://www.kotlincn.net/docs/reference/coding-conventions.html#value-arguments)
- [Class properties and parameters](https://www.kotlincn.net/docs/reference/coding-conventions.html#class-properties-and-parameters)
- [Function value parameters](https://www.kotlincn.net/docs/reference/coding-conventions.html#function-value-parameters)
- [Parameters with optional type (including setters)](https://www.kotlincn.net/docs/reference/coding-conventions.html#parameters-with-optional-type-including-setters)
- [Indexing suffix](https://www.kotlincn.net/docs/reference/coding-conventions.html#indexing-suffix)
- [Lambda parameters](https://www.kotlincn.net/docs/reference/coding-conventions.html#lambda-parameters)
- [`when` entry](https://www.kotlincn.net/docs/reference/coding-conventions.html#when-entry)
- [Collection literals (in annotations)](https://www.kotlincn.net/docs/reference/coding-conventions.html#collection-literals-in-annotations)
- [Type arguments](https://www.kotlincn.net/docs/reference/coding-conventions.html#type-arguments)
- [Type parameters](https://www.kotlincn.net/docs/reference/coding-conventions.html#type-parameters)
- [Destructuring declarations](https://www.kotlincn.net/docs/reference/coding-conventions.html#destructuring-declarations)
...
If you use a private or internal type alias for avoiding name collision, prefer the `import … as …` mentioned in  [Packages and Imports](https://www.kotlincn.net/docs/reference/packages.html).
